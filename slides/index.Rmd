...
Open the below links in three different tabs in your browser
 ...
 - [RStudio in the Cloud to follow along as I code](https://rstudio.cloud/project/1970032)
...
--
 ...
 -  **Review** how to manage  missing data in the Tidyverse within the context of EDA

--

 - **Apply** the geom_boxplot and geom_jitter function to examine the mean and spread of centrality of variables your data set
